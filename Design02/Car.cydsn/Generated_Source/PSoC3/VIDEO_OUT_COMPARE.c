...
uint8 VIDEO_OUT_COMPARE_initVar = 0u;

/* Internal functions definitoin */
static void VIDEO_OUT_COMPARE_trimAdjust(uint8 nibble) ;

/* static VIDEO_OUT_COMPARE_backupStruct  VIDEO_OUT_COMPARE_backup; */
#if (CY_PSOC5A)
    static VIDEO_OUT_COMPARE_LOWPOWER_BACKUP_STRUCT  VIDEO_OUT_COMPARE_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 VIDEO_OUT_COMPARE_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_Init
********************************************************************************
*
* Summary:
...
void VIDEO_OUT_COMPARE_Init(void) 
{
    ...
    VIDEO_OUT_COMPARE_SetSpeed(VIDEO_OUT_COMPARE_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( VIDEO_OUT_COMPARE_DEFAULT_HYSTERESIS == 0u )
        VIDEO_OUT_COMPARE_CR |= VIDEO_OUT_COMPARE_HYST_OFF;
    #else
        VIDEO_OUT_COMPARE_CR &= (uint8)(~VIDEO_OUT_COMPARE_HYST_OFF);
    #endif /* VIDEO_OUT_COMPARE_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( VIDEO_OUT_COMPARE_DEFAULT_PWRDWN_OVRD == 0u )
            VIDEO_OUT_COMPARE_CR &= (uint8)(~VIDEO_OUT_COMPARE_PWRDWN_OVRD);
        #else 
            VIDEO_OUT_COMPARE_CR |= VIDEO_OUT_COMPARE_PWRDWN_OVRD;
        #endif /* VIDEO_OUT_COMPARE_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    VIDEO_OUT_COMPARE_CR |= VIDEO_OUT_COMPARE_MX_AO;

    /* Set default sync */
    VIDEO_OUT_COMPARE_CLK &= (uint8)(~VIDEO_OUT_COMPARE_SYNCCLK_MASK);
    #if ( VIDEO_OUT_COMPARE_DEFAULT_BYPASS_SYNC == 0u )
        VIDEO_OUT_COMPARE_CLK |= VIDEO_OUT_COMPARE_SYNC_CLK_EN;
    #else
        VIDEO_OUT_COMPARE_CLK |= VIDEO_OUT_COMPARE_BYPASS_SYNC;
    #endif /* VIDEO_OUT_COMPARE_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_Enable
********************************************************************************
*
* Summary:
...
{
    VIDEO_OUT_COMPARE_PWRMGR |= VIDEO_OUT_COMPARE_ACT_PWR_EN;
    VIDEO_OUT_COMPARE_STBY_PWRMGR |= VIDEO_OUT_COMPARE_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(VIDEO_OUT_COMPARE_restoreReg == 1u)
        {
            VIDEO_OUT_COMPARE_CR = VIDEO_OUT_COMPARE_lowPowerBackup.compCRReg;

            /* Clear the flag */
            VIDEO_OUT_COMPARE_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  VIDEO_OUT_COMPARE_initVar: Is modified when this function is called for the 
...
void VIDEO_OUT_COMPARE_Start(void) 
{
    ...
    if ( VIDEO_OUT_COMPARE_initVar == 0u )
    {
        VIDEO_OUT_COMPARE_Init();
        
        VIDEO_OUT_COMPARE_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_Stop
********************************************************************************
*
* Summary:
...
void VIDEO_OUT_COMPARE_Stop(void) 
{
    ...
    VIDEO_OUT_COMPARE_PWRMGR &= (uint8)(~VIDEO_OUT_COMPARE_ACT_PWR_EN);
    VIDEO_OUT_COMPARE_STBY_PWRMGR &= (uint8)(~VIDEO_OUT_COMPARE_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        VIDEO_OUT_COMPARE_restoreReg = 1u;

        /* Save the control register before clearing it */
        VIDEO_OUT_COMPARE_lowPowerBackup.compCRReg = VIDEO_OUT_COMPARE_CR;
        VIDEO_OUT_COMPARE_CR = VIDEO_OUT_COMPARE_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_SetSpeed
********************************************************************************
*
* Summary:
...
void VIDEO_OUT_COMPARE_SetSpeed(uint8 speed) 
{
    ...
    VIDEO_OUT_COMPARE_CR = (VIDEO_OUT_COMPARE_CR & (uint8)(~VIDEO_OUT_COMPARE_PWR_MODE_MASK)) |
                           (speed & VIDEO_OUT_COMPARE_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == VIDEO_OUT_COMPARE_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            VIDEO_OUT_COMPARE_TR = VIDEO_OUT_COMPARE_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            VIDEO_OUT_COMPARE_TR0 = VIDEO_OUT_COMPARE_HS_TRIM_TR0;
            VIDEO_OUT_COMPARE_TR1 = VIDEO_OUT_COMPARE_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            VIDEO_OUT_COMPARE_TR = VIDEO_OUT_COMPARE_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            VIDEO_OUT_COMPARE_TR0 = VIDEO_OUT_COMPARE_LS_TRIM_TR0;
            VIDEO_OUT_COMPARE_TR1 = VIDEO_OUT_COMPARE_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( VIDEO_OUT_COMPARE_WRK & VIDEO_OUT_COMPARE_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_trimAdjust
********************************************************************************
*
* Summary:
...
static void VIDEO_OUT_COMPARE_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = VIDEO_OUT_COMPARE_WRK & VIDEO_OUT_COMPARE_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                VIDEO_OUT_COMPARE_TR |= VIDEO_OUT_COMPARE_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                VIDEO_OUT_COMPARE_TR0 |= VIDEO_OUT_COMPARE_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                VIDEO_OUT_COMPARE_TR |= VIDEO_OUT_COMPARE_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                VIDEO_OUT_COMPARE_TR1 |= VIDEO_OUT_COMPARE_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                VIDEO_OUT_COMPARE_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                VIDEO_OUT_COMPARE_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                VIDEO_OUT_COMPARE_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                VIDEO_OUT_COMPARE_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((VIDEO_OUT_COMPARE_WRK & VIDEO_OUT_COMPARE_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 VIDEO_OUT_COMPARE_ZeroCal(void) 
{
    ...
    tmpSW0 = VIDEO_OUT_COMPARE_SW0;
    tmpSW2 = VIDEO_OUT_COMPARE_SW2;
    tmpSW3 = VIDEO_OUT_COMPARE_SW3;

     /* Clear routing for inP, retain routing for inN */
    VIDEO_OUT_COMPARE_SW0 = 0x00u;
    VIDEO_OUT_COMPARE_SW2 = 0x00u;
    VIDEO_OUT_COMPARE_SW3 = tmpSW3 & (uint8)(~VIDEO_OUT_COMPARE_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = VIDEO_OUT_COMPARE_CR;
    VIDEO_OUT_COMPARE_CR |= (VIDEO_OUT_COMPARE_CAL_ON | VIDEO_OUT_COMPARE_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        VIDEO_OUT_COMPARE_TR = VIDEO_OUT_COMPARE_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        VIDEO_OUT_COMPARE_TR0 = VIDEO_OUT_COMPARE_DEFAULT_CMP_TRIM;
        VIDEO_OUT_COMPARE_TR1 = VIDEO_OUT_COMPARE_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (VIDEO_OUT_COMPARE_CR & VIDEO_OUT_COMPARE_PWR_MODE_MASK) == VIDEO_OUT_COMPARE_PWR_MODE_FAST)
    {
        VIDEO_OUT_COMPARE_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        VIDEO_OUT_COMPARE_trimAdjust(1u);
		VIDEO_OUT_COMPARE_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    VIDEO_OUT_COMPARE_CR = tmpCR;
    
    /* Restore routing registers for inP */
    VIDEO_OUT_COMPARE_SW0 = tmpSW0;
    VIDEO_OUT_COMPARE_SW2 = tmpSW2;
    VIDEO_OUT_COMPARE_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) VIDEO_OUT_COMPARE_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)VIDEO_OUT_COMPARE_TR1 << 8u) | (VIDEO_OUT_COMPARE_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: VIDEO_OUT_COMPARE_LoadTrim
********************************************************************************
*
* Summary:
...
void VIDEO_OUT_COMPARE_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: VIDEO_OUT_COMPARE_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: VIDEO_OUT_COMPARE_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
