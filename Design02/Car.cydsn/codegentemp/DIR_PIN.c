...
*
*  DIR_PIN_DM_STRONG     Strong Drive 
*  DIR_PIN_DM_OD_HI      Open Drain, Drives High 
*  DIR_PIN_DM_OD_LO      Open Drain, Drives Low 
*  DIR_PIN_DM_RES_UP     Resistive Pull Up 
*  DIR_PIN_DM_RES_DWN    Resistive Pull Down 
*  DIR_PIN_DM_RES_UPDWN  Resistive Pull Up/Down 
*  DIR_PIN_DM_DIG_HIZ    High Impedance Digital 
*  DIR_PIN_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
*  
* Note:
*  Macro DIR_PIN_ReadPS calls this function. 
*  
*******************************************************************************/
