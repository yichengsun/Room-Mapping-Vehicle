...
{
    uint8 staticBits = (TIMER_PIN_DR & (uint8)(~TIMER_PIN_MASK));
    TIMER_PIN_DR = staticBits | ((uint8)(value << TIMER_PIN_SHIFT) & TIMER_PIN_MASK);
}
...
{
	CyPins_SetPinDriveMode(TIMER_PIN_0, mode);
}
...
{
    return (TIMER_PIN_PS & TIMER_PIN_MASK) >> TIMER_PIN_SHIFT;
}
...
{
    return (TIMER_PIN_DR & TIMER_PIN_MASK) >> TIMER_PIN_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (TIMER_PIN_INTSTAT & TIMER_PIN_MASK) >> TIMER_PIN_SHIFT;
    }
